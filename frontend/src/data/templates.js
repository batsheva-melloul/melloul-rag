...
export const TEMPLATES = [
  ...
  },
  {
    ...
    icon: "🎬",
    directive:
      "בנה מצגת תמציתית על הנושא שבשאלה, לפי המסמכים בלבד. חלק אותה לשקופיות: כל " +
      "שקופית מתחילה בכותרת בשורה נפרדת בפורמט '## <כותרת השקופית>', ומתחתיה 3 עד 5 " +
      "נקודות קצרות (כל נקודה בשורה שמתחילה ב-'- '), כשכל נקודה היא משפט אחד קצר של עד " +
      "כ-12 מילים. הפק 6 עד 9 שקופיות. השקופית הראשונה בכותרת '## סקירה כללית' עם תמצית " +
      "הנושא. אל תכתוב פסקאות ארוכות, טבלאות או קוד — רק כותרות ונקודות תמציתיות. " +
      "אם אין במסמכים מספיק מידע על הנושא, אמור זאת בפשטות ואל תמציא.",
  },
  {
    id: "summary",
    label: "תקציר",
