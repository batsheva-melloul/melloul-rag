...
export const TEMPLATES = [
  ...
  },
  {
    ...
    icon: "🎬",
    directive:
      "בנה מצגת על הנושא שבשאלה, לפי המסמכים בלבד. החזר JSON תקין (ותו לא) בתוך בלוק " +
      "```slides, במבנה המדויק:\n" +
      '{"title":"<כותרת המצגת>","slides":[{"title":"<כותרת השקופית>","bullets":["<נקודה קצרה>","<נקודה קצרה>"]}]}\n' +
      "הפק 6 עד 10 שקופיות. לכל שקופית 3 עד 5 נקודות, כל נקודה משפט אחד קצר (עד כ-12 " +
      "מילים) — לא פסקאות. השקופית הראשונה 'סקירה כללית' עם תמצית הנושא. אל תכתוב שום " +
      "טקסט מחוץ לבלוק. אם אין במסמכים מספיק מידע על הנושא, אל תחזיר JSON — כתוב במשפט " +
      "פשוט שאין מספיק מידע על כך במסמכים.",
  },
  {
    id: "summary",
    label: "תקציר",
